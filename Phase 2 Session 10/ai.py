...
class Actor(nn.Module):
    def __init__(self, state_dim, action_dim, max_action):
        ...
        self.convblock1 = nn.Sequential(nn.Conv2d(in_channels=state_dim[2], out_channels=8, kernel_size=(3, 3), padding=(1,1), bias=False), nn.ReLU(), nn.BatchNorm2d(8), nn.Dropout(0.1))  # output_size = 32
        ...
        self.convblock7 = nn.Sequential(nn.Conv2d(in_channels=16,out_channels=16,kernel_size=(3, 3),padding=(1,1),bias=False),nn.ReLU(),nn.BatchNorm2d(16),nn.Dropout(0.1)) #output 8

        self.convblock8 = nn.Sequential(nn.Conv2d(in_channels=16,out_channels=16,kernel_size=(3, 3),padding=(1,1),bias=False),nn.ReLU(),nn.BatchNorm2d(16),nn.Dropout(0.1)) # output 8

        self.convblock9 = nn.Sequential(nn.Conv2d(in_channels=16,out_channels=16,kernel_size=(3, 3),stride=2,bias=False)) # output 4
...
class Critic(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        self.convblock11 = nn.Sequential(nn.Conv2d(in_channels=state_dim[2],out_channels=8,kernel_size=(3, 3),padding=(1,1),bias=False),nn.ReLU(),nn.BatchNorm2d(8),nn.Dropout(0.1))  # output_size = 32
        ...
        self.convblock77 = nn.Sequential(nn.Conv2d(in_channels=16,out_channels=16,kernel_size=(3, 3),padding=(1,1),bias=False),nn.ReLU(),nn.BatchNorm2d(16),nn.Dropout(0.1)) #output 8

        self.convblock88 = nn.Sequential(nn.Conv2d(in_channels=16,out_channels=16,kernel_size=(3, 3),padding=(1,1),bias=False),nn.ReLU(),nn.BatchNorm2d(16),nn.Dropout(0.1)) # output 8

        self.convblock99 = nn.Sequential(nn.Conv2d(in_channels=16,out_channels=16,kernel_size=(3, 3),stride=2,bias=False)) # output 4
